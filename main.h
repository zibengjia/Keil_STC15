...
extern unsigned char code MoonPlot[];
extern unsigned char code SeeUAgain[];
enum Mode {
    KeyBoard = 0,
    MusicPlay,
    ClockSet,
...
unsigned char code *code MusicName[] = {"Haruhikage", "Keep Walking", "GGB", "Two Butterflies", "Orchid Grass", "The Coolest Ethnic Trend", "MoonPlot", "SeeUAgain"};
unsigned char code *code MusicData[] = {Music_Chun, Music_Girl, Music_GGB, Music_Two, Music_Cao, Music_ZuiXuan, MoonPlot, SeeUAgain};
